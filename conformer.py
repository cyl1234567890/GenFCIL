...
class Conformer(nn.Module):
    ...
    def __init__(self, patch_size=16, in_chans=3, num_classes=100, base_channel=64, channel_ratio=4, num_med_block=0,
                 embed_dim=768, depth=9, num_heads=12, mlp_ratio=4., qkv_bias=False, qk_scale=None,
    ...
    def forward(self, x):
        ...
        can= torch.cat((conv_cls, tran_cls), dim=0)
        #can = self.can(can)
        #return can
        return conv_cls
